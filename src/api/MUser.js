...
export const login = (params) =>
  axios({
    method: "post",
    // url: "http://192.168.2.228:9090/user/login",
...
export const register = (params) =>
  axios({
    method: "post",
    // url: "http://192.168.2.228:9090/user/register",
...
export const getMuserInfoByName = (uname) =>
  axios({
    // url: `http://192.168.2.228:9090/user/info?uname=${uname}`,
...
export const getMuserByName = (uname) =>
  axios({
    // url: `http://192.168.2.228:9090/user/muser?uname=${uname}`,
...
export const uptPass = (params) =>
  axios({
    method: "post",
    // url: "http://192.168.2.228:9090/user/uptPass",
...
export const uptImg = (params) =>
  axios({
    method: "post",
    url: "http://192.168.2.228:9090/user/uptImg",
...
export const uptMsg = (params) =>
  axios({
    method: "post",
    // url: "http://192.168.2.228:9090/user/uptMsg",
    // url: "http://localhost:3000/api/user/uptMsg", // vercel离线调试
    url: "https://music-back-node.vercel.app/api/user/uptMsg",
    data: params,
    // 设置请求头为这个,才能传递文件
    headers: {
...
export const addLike = (params) =>
  axios({
    method: "post",
    url: "http://192.168.2.228:9090/music/addLike",
    data: params,
    headers: {
      "Content-Type": "application/json",
    },
...
export const getLikes = (uid) =>
  axios({
    url: `http://192.168.2.228:9090/music/getLikes?uid=${uid}`,
    method: "GET",
  });
// 从我喜欢的音乐中移除歌曲(根据uid和mid)
export const delLike = (params) =>
  axios({
    url: `http://192.168.2.228:9090/music/delLike`,
    method: "delete",
    params,
  });
// 添加好友
export const addFriend = (params) =>
  axios({
    url: `http://192.168.2.228:9090/friend/addFriend`,
    method: "post",
    data: params,
    headers: {
      "Content-Type": "multipart/form-data",
...
export const getFriends = (uid) =>
  axios({
    ...
    url: `http://192.168.2.228:9090/friend/getFriends?uid=${uid}`,
    method: "GET",
  });
// 通过fid获取好友信息
export const getFriendsByFid = (fid) =>
  axios({
    url: `http://192.168.2.228:9090/friend/getFriendByFid?fid=${fid}`,
    method: "GET",
  });
// 根据fid删除好友
export const delFriend = (params) =>
  axios({
    url: `http://192.168.2.228:9090/friend/delFriend`,
    method: "delete",
    params,
  });
